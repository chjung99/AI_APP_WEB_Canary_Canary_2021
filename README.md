...
예를 들어 군대만이 아닌 다른 조직에서의 보안 위반 객체를 모자이크할 때, 사용자의 특성에 따라 잔인하거나 선정적인 장면 등을 자동으로 처리할 필요가 있을 때 등에서 이 시스템을 활용해볼 수 있습니다. timeline을 학습할 수 있는 transformer와 같이 적용한다면 영상처럼 맥락을 고려할 필요가 있는 자료 역시 처리 가능합니다. 
