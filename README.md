...
<details>
 ...
 ### 문제 발견하기
   ...
   - 하지만 군사 보안을 이유로 휴대폰의 중요한 기능인 카메라 사용을 전면적으로 통제 하고 있는 상황입니다.  
 ...
 - 그러나 카메라 사용을 무제한 허용 시 군사기밀 등의 유출 가능성이 존재, 국가 안보에 심각한 위협이 가해질 수 있습니다.
 
 ### 아이디어 내기
 
 - 보안 위반 가능성이 있는 요소들을 식별하여 모자이크 처리를 해 주는 카메라를 만들 것입니다.
 - 모호한 군사 보안 규정을 정확하게 알려주어, 보안 사고를 사전에 방지합니다.
