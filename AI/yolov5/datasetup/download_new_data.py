...
DATA_ID = '1ZC7JjZwB8MBIKmLw_tZBd6SaBTnP2yvb'
DATA_PATH = f'{DATA_ROOT_DIR}/canary'
...
def split(dir_name, train_ratio=0.95):
    ...
    train_index = set(np.random.randint(int(data_len * train_ratio), size=data_len).flatten())
