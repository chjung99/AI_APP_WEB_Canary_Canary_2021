...
def post_check(cl,user_id,thread_id):
...
def get_recent_three_unchecked_medias(cl,user_id):
    ...
    download_media(cl,user_medias_for_test,user_id)

    print('3 Posts Downloading process done')

# story 검사
def get_recent_stories(cl,user_id):
    ...
    download_story(cl,user_stories_for_test,user_id)
...
def download_media(cl,medias,user_id):
...
def download_story(cl,stories,user_id):
        # User들의 사진을 저장할 directory 생성
    input_path = save_imgs_INPUT(user_id)
