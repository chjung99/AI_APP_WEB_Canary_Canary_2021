...
// images폴더에 관하여 정적인 접근을 가능하게 해줌 
// ex: https://osam-project-testing-tkqtg.run.goorm.io/sample.jpg 는 images 폴더 안의 sample.jpg를 출력해준다.
...
app.listen(4000,(err)=>{
	if (err){
		console.error('서버 구동 에러')	
	} else{
		console.log('running on 4000 successful')
	}
})